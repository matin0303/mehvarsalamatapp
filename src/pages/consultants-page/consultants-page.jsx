...
export default function ConsultantsPage() {
  ...
  const filterCategories = [
    { key: 'all', label: 'همه' },
    { key: 'nutrition', label: ' مشاور تغذیه' },
    { key: 'clinical_psychologist', label: ' روانشناس بالینی' },
    { key: 'family_counselor', label: ' مشاور خانواده' },
    { key: 'psychiatrist', label: ' روانپزشک' },
    { key: 'child_counselor', label: ' مشاور کودک و نوجوان' },
  ];
  ...
  useEffect(() => {
    ...
    setConsultants([
      {
        id: 1,
        categoryKey: 'clinical_psychologist',
    ...
    // استایل‌دهی المنت‌های نوار بالایی
    ...
    navElements.forEach((a) => {
      a.style.color = '#368600fb';
    });
    menu_btns.forEach((btn) => {
      btn.style.color = '#368600fb';
    });
    if (logo) logo.style.color = '#368600fb';
          ...
          <main className="consultant-main">
            <div className="search-container">
              <div className="search">
                ...
                />
                <span className="material-symbols-outlined">data_loss_prevention</span>
              </div>
            </div>

            {/* دکمه‌های دسته‌بندی با اسکرول افقی */}
